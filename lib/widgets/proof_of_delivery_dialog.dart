...
class ProofOfDeliveryDialog extends StatefulWidget {
  ...
  const ProofOfDeliveryDialog({super.key, required this.delivery});
    ...
    try {
      ...
      if (_deliveryPhoto != null) {
        ...
        photoUrl = await _uploadService
            .uploadProofOfDelivery(_deliveryPhoto!, widget.delivery.id)
            .timeout(
        ...
        photoUrl = 'https://placeholder.dev/no-photo'; // Placeholder for dev
      }
            ...
            child: Column(
              ...
              children: [
                ...
                OutlinedButton.icon(
                  ...
                  style: OutlinedButton.styleFrom(
                    foregroundColor: _signatureData != null
                        ? Colors.green
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        onPressed: _isUploading ? null : _submitProofOfDelivery,
                        icon: _isUploading
                            ? const SizedBox(
                                width: 20,
                                height: 20,
